...
const SendUs = () => {
  ...
  return (
    <div className="bg-[#FEF9FF] xl:mt-[88px] xl:mr-[88px] xl:mb-[96px]  md:w-auto h-auto rounded-[10px] md:mx-[20px] mb-[54px] mt-[19px] w-auto mx-[20px] ">
      ...
      <button onClick={()=> clearState()} className="bg-[#7153A9] text-white border-[#3B2862] border-[2px] xl:w-[108px] xl:h-[39px] xl:ml-[57px] xl:text-[20px] md:w-[139px] md:h-[40px] md:ml-[25px] mb-[32px] w-[61px] h-[39px] ml-[11px] text-[16px] cursor-pointer rounded-[10px] ">
        ส่ง
