    ...
    <div className="flex justify-center">
      <div className="xl:mt-[88px] mt-[72px]">
        <div className="flex md:mb-[32px] mb-[16px] xl:mt-[16px] md:mt-[12px] mt-[16px]">
          <NavLink to="/" className="text-[#888888] xl:text-xl md:text-base text-sm">
            หน้าหลัก
          </NavLink>
          <h1 className="text-[#888888] xl:text-xl md:text-base text-sm">&nbsp; &gt; &nbsp;</h1>
          <NavLink to="/services" className="text-[#888888] xl:text-xl md:text-base text-sm">
            บริการ
          </NavLink>
          <h1 className="text-[#888888] xl:text-xl md:text-base text-sm">&nbsp; &gt; &nbsp;</h1>
          <NavLink to="/services/illustration" className="text-[#303030] xl:text-xl md:text-base text-sm">
            ภาพประกอบ
          </NavLink>
        </div>
        <div>
          ...
          <h1 className="xl:text-xl md:text-base xl:mt-[13px] xl:mb-6 md:my-[9px] my-[8px] font-light md:font-normal">ภาพประกอบ</h1>
        </div>
