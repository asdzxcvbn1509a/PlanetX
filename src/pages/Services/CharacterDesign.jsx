    ...
    <div className="flex justify-center">
      <div className="xl:mt-[88px] md:mt-[72px]">
        <div className="flex mb-[32px] xl:mt-[16px] md:mt-[12px]">
          ...
          <h1 className="text-[#888888] xl:text-xl md:text-base">&nbsp; &gt; &nbsp;</h1>
          <NavLink to="/services/character" className="text-[#303030] xl:text-xl md:text-base">
            ออกแบบตัวละคร
          </NavLink>
        </div>
        <div>
          ...
          <h1 className="xl:text-xl md:text-base xl:mt-[13px] xl:mb-6 my-[9px]">ออกแบบตัวละคร</h1>
        </div>
